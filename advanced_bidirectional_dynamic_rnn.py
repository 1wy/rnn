...
# coding: utf-8
# in this example, we use the generated character as inputs for decoder rather than
# inputs manually set.
import helpers
...
encoder_inputs_length = tf.placeholder(shape=(None), dtype=tf.int32, name='decoder_inputs')
